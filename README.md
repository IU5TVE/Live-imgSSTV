...
#
This is an image of one of the two launches in which we used this script. The graphic shows the image captured in real time, the call sign assigned to the high school, the email address for QSLs, and the weather data retrieved from the radiosonde. 
