...
#
This is an image of one of the two launches in which we used this script, broadcast in PD120 mode. The graphic shows the image captured in real time, the callsign assigned to the high school, the email address for QSLs, and the weather data retrieved from the radiosonde. 
